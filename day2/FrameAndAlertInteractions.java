...
public class FrameAndAlertInteractions {
	...
	public static void main(String[] args) {
		...
		// Entering a name in the prompt alert text box
		promptAlert.sendKeys("Hema");
		// Clicking ok button
		promptAlert.accept();
		// promptAlert.dismiss();
		// Getting the text that is displayed after clicking one of the buttons of prompt alert
